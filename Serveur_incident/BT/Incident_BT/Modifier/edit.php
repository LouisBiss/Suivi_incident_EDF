...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"UPDATE historique_BT SET depart='$depart', poste='$poste', cause='$cause', incident='$incident', com='$com', sympa='$sympa', autre='$autre', date='$date' WHERE id='$id'");
