...
<!--Bouton Export -->
<form method="post" action="export_siège.php" class="row">
...
<table >
    ...
    <?php
        ...
        $siège = strip_tags($_POST['siège']);

        $records = mysqli_query($db,"SELECT * from historique_BT WHERE siège='$siège'"); // fetch data from database
