...
<!--Bouton Export-->
<form method="post" action="export_cause.php" class="row">
...
<table >
    ...
    <?php
        ...
        $records = mysqli_query($db,"SELECT * from historique_BT WHERE cause='$cause' ORDER BY date DESC"); // fetch data from database
