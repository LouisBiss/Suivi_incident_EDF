...
<!--Bouton Export -->
<form method="post" action="export_sympa.php" class="row">
...
<table >
    ...
    <?php
        ...
        $sympa = strip_tags($_POST['sympa']);

        $records = mysqli_query($db,"SELECT * from historique_BT WHERE sympa='$sympa'"); // fetch data from database
