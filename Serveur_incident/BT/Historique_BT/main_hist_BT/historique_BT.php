...
<head>
    ...
    <link rel="stylesheet" href="historique_BT.css">
...
<body>
    ...
    <!--en-tete page-->
    <div class="TITRE">
        <p class="text_tire">HISOTRIQUE DES INCIDENTS BT <p>
    </div>
    ...
    <?php
        ...
        $records = mysqli_query($db,"SELECT * from historique_BT ORDER  BY date DESC"); // fetch data from database
