...
<body>
    ...
    <div class="données">
        <label for="">Nouveau Siège</label>
            <input class="code" type="text" id="siège" name="siège">
     ...
     <table >
        ...
        <p class="sous_titre">Liste des sièges</p> 
        <?php
        
        include "connect_sql.php"; // Using database connection file here

        $records = mysqli_query($db,"SELECT * from siège"); // fetch data from database
