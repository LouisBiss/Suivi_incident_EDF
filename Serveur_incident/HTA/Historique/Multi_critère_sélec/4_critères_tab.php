...
<table >
    ...
    <?php
        ...
        $choix4 = strip_tags($_POST['choix4']);

        $crit1 = strip_tags($_POST['crit1']);
        $crit2 = strip_tags($_POST['crit2']);
        $crit3 = strip_tags($_POST['crit3']);
        $crit4 = strip_tags($_POST['crit4']);



        $records = mysqli_query($db,"SELECT * from historique WHERE $choix1='$crit1' AND $choix2='$crit2' AND $choix3='$crit3' AND $choix4='$crit4' ORDER BY date DESC"); // fetch data from database
