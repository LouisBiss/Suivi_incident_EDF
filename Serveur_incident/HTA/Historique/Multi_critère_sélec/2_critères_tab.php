...
<!--Bouton Export  -->
<form method="post" action="2_export.php" class="row">
...
<table >
    ...
    <?php
        ...
        $records = mysqli_query($db,"SELECT * from historique WHERE $choix1='$crit1' AND $choix2='$crit2' ORDER BY date DESC"); // fetch data from database
